...
{
    public sealed class RegularSelect : SelectBase
    {
        ...
        internal RegularSelect(IReadOnlyDictionary<string, ColumnReference> memberColumnMap, Delegate projector, string sourceAlias, IEnumerable<Column> columns, SourceBase source, int offset, int? limit = null)
            : this(memberColumnMap, projector, sourceAlias, columns, source, null, Enumerable.Empty<Order>(), false, offset, limit)
        {

        }

        internal RegularSelect(IReadOnlyDictionary<string, ColumnReference> memberColumnMap, Delegate projector, string sourceAlias, IEnumerable<Column> columns, SourceBase source, bool distinct)
            : this(memberColumnMap, projector, sourceAlias, columns, source, null, Enumerable.Empty<Order>(), distinct, 0, null)
        {

        }

        internal RegularSelect(IReadOnlyDictionary<string, ColumnReference> memberColumnMap, Delegate projector, string sourceAlias, IEnumerable<Column> columns, SourceBase source, QueryExpression predicate = null)
            : this(memberColumnMap, projector, sourceAlias, columns, source, predicate, Enumerable.Empty<Order>(), false, 0, null)
        {

        }

        internal RegularSelect WithAdditionalOrder(params Order[] orders)
        {
        ...
        internal RegularSelect(IReadOnlyDictionary<string, ColumnReference> memberColumnMap, Delegate projector, string alias, IEnumerable<Column> columns, SourceBase source, 
